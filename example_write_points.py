...
d = 0.1
xmax = yi
pts_exp_cont = tbdmk.points_exponential_discontinuous_decline_noisy(yi, d, xmax, xmax, 1.0)
tbdpt.write_points('data_demo/points_01.json', pts_exp_cont)

xdisc = 20.0
pts_exp_discont = tbdmk.points_exponential_discontinuous_decline_noisy(yi, d, xmax, xdisc)
